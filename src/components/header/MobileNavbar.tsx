...
function MobileNavbar({ open }: { open: boolean }) {
  return (
    <nav
      className={`${open ? "flex" : "hidden"} absolute left-0 top-[calc(100%+20px)] w-full flex-col gap-2 rounded-2xl border border-[#4e4e4e] bg-[#1E1E1E1A] px-6 py-4 backdrop-blur-md md:hidden`}
    >
