...
function HeroIllustration() {
  ...
  return (
    <div
      data-aos="fade-up"
      className="relative z-0 grid h-full overflow-hidden rounded-lg bg-[#0D0D0D] pt-10 max-lg:px-[20px] lg:grid-cols-[1fr_58%] lg:pt-20 ltr:pl-10 rtl:pr-10"
    >
      {/* Blurry Dots: */}
      ...
      <div className="flex flex-col gap-8 max-lg:items-center max-lg:text-center lg:pb-20">
        <h3 data-aos="fade-up" className="text-2xl font-black">
          {hero_title[websiteLang]}
        </h3>
        <p data-aos="fade-up">{hero_description[websiteLang]}</p>
        <ContactLink bgColorClassName="bg-background" />
      </div>

      <div
        data-aos="fade-up"
        className="bottom-0 mx-auto mt-auto lg:absolute lg:w-[72%] ltr:right-0 rtl:left-0"
      >
